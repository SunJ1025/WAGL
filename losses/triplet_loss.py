...
class TripletLoss(object):
    ...
    def __call__(self, global_feat, labels, normalize_feature=False):
        ...
        if self.margin is not None:
            ...
            loss = self.ranking_loss(dist_an - dist_ap, y) + dist_ap.min()
...
class Tripletloss(nn.Module):
    ...
    def __init__(self, margin=0.3, hard_factor=0.0, balance=1.0):
    ...
    def forward(self, inputs, targets):
        ...
        loss = self.ranking_loss(dist_an, dist_ap, y) + dist_ap.mean() * self.balance  # *0.9
