...
# 获取测试集地址
parser.add_argument('--test_dir', default='./data/SUES-200-512x512/Testing', type=str, help='test data path')
# 输出模型的名字
parser.add_argument('--name', default='trained_model_name', type=str, help='save model path')
# choose hight
parser.add_argument('--hight', default='150', type=str, help='chose evaluate hight')
# num classes
parser.add_argument('--classes', default=701, type=int, help='num classes')
# 测试使用的 batchsize 大小
...
# 加载测试数据集
image_datasets = {x: datasets.ImageFolder(os.path.join(test_dir, hight, x), data_transforms)
