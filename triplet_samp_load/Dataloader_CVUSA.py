...
class Dataloader_CVUSA(Dataset):
    def __init__(self, root, transforms, names=['satellite', 'street']):
        super(Dataloader_CVUSA).__init__()
        self.transforms_drone_street = transforms['street']   # 加载数据增强操作
    ...
    def __getitem__(self, index):
        ...
        img, label_id_dr = self.sample_from_cls("street", cls_nums)
...
if __name__ == '__main__':
    ...
    datasets = Dataloader_CVUSA(root="../data/cvpr2017_cvusa/train", transforms=transform_train_list, names=['satellite', 'street'])
